Helicopter Shooter Game – C# Project
...
It includes:
Analysis of modern gaming platforms (console, mobile, streaming)

Consideration of game design factors such as target audience, graphics, and mechanics

Implementation of a functional 2D game using C#

Evaluation of interaction methods and gameplay experience

Functionality testing and improvement recommendations
...
Score tracking system displayed during gameplay

End‑of‑game results shown in a message box

Friendly background colours for an immersive atmosphere

Simple, intuitive interaction methods
...
Visual design and graphical elements
